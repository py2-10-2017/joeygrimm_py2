...
select actor.actor_id, concat(actor.first_name, ' ', actor.last_name) as artist, title, film.description, film.release_year
from film
...
select film.film_id, film.title, actor.actor_id, concat(actor.first_name, ' ', actor.last_name) as artist_name
from film
join film_actor on film.film_id = film_actor.film_id
join actor on film_actor.actor_id = actor.actor_id
